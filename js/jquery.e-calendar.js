...
(function ($) {
    ...
    var eCalendar = function (options, object) {
        ...
        var adDay = 0;
        var adYear = new Date(start).getFullYear();
        var adMonth = new Date(start).getMonth();
        var adDay = new Date(start).getDate();
...
//            cEvents.append(cEventsBody);
            ...
            for (var i = 0; i < 42; i++) {
                ...
                if (i < dWeekDayOfMonthStart) {
                    ...
                    if (day >= startDay && day <= endDay && adMonth == dMonth && adYear == dYear) {
